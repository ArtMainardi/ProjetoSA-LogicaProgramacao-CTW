...
public class ManutencaoService {
    ...
    public Manutencao salvar(Manutencao objeto){
        ...
        if(objeto.getDataAbertura().trim().isEmpty() || objeto.getDataEncerramento().trim().isEmpty() || objeto.getTipoManutencao().trim().isEmpty()
                || objeto.getDataEncerramento().trim().isEmpty()){
