...
public class Manutencao {
    ...
    // Construtor com ID (recebe um objeto já criado da lista, sem data de encerramento):
    public Manutencao(int codigo, Equipamento equipamento, Tecnico tecnico, String dataAbertura, String tipoManutencao, String descricao, String situacao) {
        this.codigo = codigo;
        this.equipamento = equipamento;
        this.tecnico = tecnico;
        this.dataAbertura = dataAbertura;
    ...
    // Construtor com ID (recebe um objeto já criado da lista, com data de encerramento):
