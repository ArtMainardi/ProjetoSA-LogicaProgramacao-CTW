...
public class MovimentacoesMain {
    // Variáveis:
    static Dados d;
    static Style sty;
    static Scanner sc;
    ...
    public static void movimentacoes(Dados dados, Style style, Scanner scanner){
        ...
        do {
            try {
                sty.titulo("Gerenciar Movimentações");
                System.out.println("Digite uma opção: \n"
                                + "1- Cadastrar movimentação \n"
                                + "2- Consultar movimentação pelo código \n"
                                + "3- Alterar situação da manutenção \n"
                                + "4- Finalizar manutenção \n"
                                + "5- Listar todas as movimentações cadastrados \n"
                                + "0- Voltar"
                );
                ...
                switch (option) {
                    case 0: // Cadastrar uma nova movimentação:
    ...
    // Método que retorna nova movimentação cadastrada:
    public static Movimentacao cadastrar(){
        Main.clear();
