...
import projetoSA.exceptions.SwitchCaseException;
...
public class EquipamentosMain {
    ...
    public static void equipamentos(Dados dados, Style style, Scanner scanner, Relatorio r){
            ...
            try{
                ...
                switch (option) {
                    case 1: // Cadastrar um novo equipamento:
                        ...
                        // Atualiza relatório:
                        relatorio.setQtdEquipamentos(relatorio.getQtdEquipamentos() + 1);
                        Main.continuar();
                        break;
