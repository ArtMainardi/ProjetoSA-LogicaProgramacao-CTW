...
public class Main {
    ...
    public static void mostrarRelatorio(){
        ...
        System.out.println("Quantidade total de equipamentos cadastrados: " + relatorio.getQtdEquipamentos());
        System.out.println("Quantidade total de técnicos cadastrados; : " + relatorio.getQtdEquipamentos());
    }
}